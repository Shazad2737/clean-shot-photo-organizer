"""
Beautiful, modern main window with stunning visual design.
"""
...
from PySide6.QtWidgets import (QMainWindow, QVBoxLayout, QHBoxLayout, QWidget, 
                               ...
                               QSplitter, QScrollArea, QTextEdit, QGraphicsDropShadowEffect)
from PySide6.QtCore import Qt, QTimer, QPropertyAnimation, QEasingCurve, QRect
from PySide6.QtGui import QFont, QIcon, QAction, QPalette, QColor, QLinearGradient
...
from gui.modern_styles import APPLICATION_STYLE, BUTTON_STYLES, WIDGET_STYLES, COLORS, GRADIENTS


class BeautifulMainWindow(QMainWindow):
    """Stunning main application window with modern design."""
    ...
    def setup_ui(self):
        ...
        # Central widget with beautiful background
        ...
        self.create_stunning_header(main_layout)
    ...
    def create_stunning_header(self, layout):
        """Create a stunning header section."""
        header_frame = QFrame()
        ...
        self.select_btn.setStyleSheet(BUTTON_STYLES['glass'])
    ...
    def create_beautiful_right_panel(self):
        ...
        self.progress_widget.setStyleSheet("QWidget { background: transparent; }")
        ...
        self.results_widget.setStyleSheet("QWidget { background: transparent; }")
    ...
    def setup_menu(self):
        ...
        clear_action = QAction('🗑️ &Clear Results', self)
    ...
    def setup_animations(self):
        ...
        # Create animation for button hover effects
        self.animation_timer = QTimer()
        self.animation_timer.timeout.connect(self.update_animations)
        self.animation_timer.start(16)  # 60 FPS
    
    def update_animations(self):
        """Update animations for smooth effects."""
        # This would handle any custom animations
        pass
